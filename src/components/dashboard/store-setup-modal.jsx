...
export default function StoreSetupModal({ onComplete }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center px-5 bg-black/50 backdrop-blur-sm animate-fade-in">
      <div className="w-full max-w-sm bg-white dark:bg-zinc-900 rounded-3xl p-6 shadow-2xl animate-slide-up">
        {/* Icon */}
        ...
        <p className="mt-1 text-xs text-zinc-500 dark:text-zinc-400 font-medium mb-5 leading-relaxed">
          Masukkan nama toko atau usaha supaya tampilan lebih personal.
        </p>

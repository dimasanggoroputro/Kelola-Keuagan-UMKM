...
export default function ReceiptScanner({ onSave, onClose }) {
  ...
  if (status === "review" && parsedResults) {
    return (
      <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center">
        ...
        <div className="relative w-full sm:max-w-2xl bg-white dark:bg-zinc-950 rounded-t-3xl sm:rounded-3xl shadow-2xl animate-slide-up overflow-hidden max-h-[90vh] sm:max-h-[85vh]">
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center">
      ...
      {/* Sheet panel */}
      <div className="relative w-full sm:max-w-md bg-white dark:bg-zinc-950 rounded-t-3xl sm:rounded-3xl p-6 shadow-2xl animate-slide-up max-h-[90vh] overflow-y-auto">
